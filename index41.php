  ...
  <link rel="stylesheet" href="style41.css">
    ...
    <body>
      <nav class="navbar navbar-default navbar-fixed-top">
       ...
       <img class="img-responsive" src="tiger.png">
        ...
        <div class="jumbotron">
            <p class="p1">Players Performance in Match Form</p>
            <hr>
            <form method="post" action="registration41.php">
                <div class="divag">
                <div class="form-group row form-inline">
                   
                    <label class="l40">Match ID :</label> <input class="form-control f1 input-sm" type="text" name="matchid" placeholder="Enter Match ID" autocomplete="off">
                </div>
                <div class="form-group row form-inline">

                    <label class="l41">Venue ID :</label> <input class="form-control f2 input-sm" type="text" name="venueid" placeholder="Enter Venue ID" autocomplete="off">
                </div>
                <div class="form-group row form-inline">

                    <label class="l42">Date of the Match :</label> <input class="form-control f3 input-sm" type="text" name="matchdate" placeholder="(DD-MM-YYYY)" autocomplete="off">
                </div>
    ...
    <tbody>
      <tr>
        ...
        <td><input type="text" class="inp" autocomplete="off" name="totwick"></td>
        <td><input type="text" class="inp" autocomplete="off" name="totrun"></td>
        <td><input type="text" class="inp" autocomplete="off" name="performance"></td>
