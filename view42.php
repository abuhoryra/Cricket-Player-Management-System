...
$add="SELECT P.matchid,P.matchdate,P.manmatch,P.umpire
          FROM matches3 P";
  ...
  <div class="col-xl-12">
   ...
   <table class="table">
    ...
    <?php
      ...
      while ($res = mysqli_fetch_array($result)and$res1 = mysqli_fetch_array($rim)and$res2 = mysqli_fetch_array($top) and$res3 = mysqli_fetch_array($top1)) {
             ...
             ?>
              ...
              <td><?php echo $res3['matchid']; ?></td>
              <td><?php echo $res3['manmatch']; ?></td>
              <td><?php echo $res3['umpire']; ?></td>
